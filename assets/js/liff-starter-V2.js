...
*/
var liffId = "1654728399-v0lbwLzG";
...
function initApp() {
    ...
    if (!liff.isLoggedIn()) {
        ...
        liff.getProfile().then(profile => {
            ...
            document.getElementById("greet").innerHTML = "Hi, " + userDisplayName + " ౼ Selamat datang";
        }).catch((err) => {
...
function sendLiffMessage() {
    ...
    if (type == "profile") {
        sendMessages([{type: "flex", altText: "Profile " + userDisplayName, contents: {type: "bubble", hero: {type: "image", url: userPictureUrl, size: "full", aspectRatio: "1:1", aspectMode: "cover", action: {type: "uri", uri: "https://app/1654728399-v0lbwLzG?auto=yes&type=image&downloadUrl=" + userPictureUrl + "&previewUrl=" + userPictureUrl } }, body: {type: "box", layout: "vertical", contents: [{type: "text", text: userDisplayName, align: "center", weight: "bold", size: "xl"}, {type: "box", layout: "vertical", margin: "lg", spacing: "sm", contents: [{type: "text", text: userStatusMessage, wrap: true, color: "#ffff00", size: "sm", maxLines: 5, flex: 5 }] } ] }, footer: {type: "box", layout: "horizontal", spacing: "sm", contents: [{type: "button", style: "primary", height: "sm", color: "#40e0d0", action: {type: "uri", label: "Creator Caem", uri: "https://line.me/ti/p/~ups23"}}, {type: "button", style: "primary", height: "sm", action: {type: "uri", label: "Profile", uri: "https://app/1654728399-v0lbwLzG?auto=yes&type=profile"}}, {type: "spacer", size: "sm"}]}}}]); 
    } else if (type == "text") {
        sendMessages([{
            type: "text",
